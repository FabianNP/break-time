...
import { CHARACTERS, RARITY_COLORS, hexToRgb } from '../data/gameData'
        ...
        <div className="grid-char-page">
          ...
          <div>
            ...
            <div className="px-corner" style={{
              ...
              <div className="anim-float" style={{ filter:`drop-shadow(0 0 28px ${char.color})`, position:'relative' }}>{char.emoji}</div>
